...
<div class="clearfix">
	...
	{{/if}}
	{{if $config.backCardLink() && $page.site !== "secondHand"}}
	...
	<a href="${$config.URL.installExplain}" target="query"  class="fr tip pr30 cl pr" >
		<i class="c-i tips fl" style="margin:5px 5px 0px 0px;"></i>
		<span class="fl">安装说明</span>
	</a>
</div>
{{if $page.site=="gomeVirtualCard"}}
<div class="list-box">
	...
	<div class="info-bd clearfix">
		...
		<div class="backStyle">
            ...
            <div class="fr" style="top:0px;padding-right:20px;position: relative;" hoverup-fee>
                <span class="shipfee-tip">运费：{{html $config.shipTip(shop)}}</span>
